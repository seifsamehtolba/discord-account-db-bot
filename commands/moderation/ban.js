...
module.exports = {
    ...
    run: async (client, message, args) => {
        const logChannel = message.guild.channels.cache.find(c => c.name === "staff-chat") || message.channel;
        ...
        const embed = new MessageEmbed()
            .setColor("#ff0000")
            .setThumbnail(toBan.user.displayAvatarURL({format: "png", dynamic: true}))
        ...
        await message.channel.send(promptEmbed).then(async msg => {
            ...
            if (emoji === "✅") {
                ...
                toBan.send(`You have been banned from Flawed Gen! because of ${args.slice(1).join(" ")}`)
            } else if (emoji === "❌") {
                msg.delete();
